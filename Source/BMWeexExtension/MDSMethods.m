...
+(void)exchangeWeexDefault
{
    ...
    /** 获取自定义的mds_registerDefaultHandlers方法 */
    Method exchangeM = class_getClassMethod([WXSDKEngine class], @selector(mds_registerDefaultHandlers));
...
//    
//    /** 获取自定义的mds_registerDefaultModules方法 */
//    exchangeM = class_getClassMethod([WXSDKEngine class], @selector(mds_registerDefaultModules));
//    
//    /** 交换方法 */
//    method_exchangeImplementations(originalM, exchangeM);
...
+(void)exchangeWeexAddRule
{
    ...
    /** 获取自定义的addRule方法 */
    Method exchangeM = class_getClassMethod([MDSAddRuleManager class], @selector(addRule:rule:));
...
+(void)exchangeWeexInputComponent
{
    ...
    /** 获取自定义的addRule方法 */
    Method exchangeM = class_getClassMethod([WXEditComponent class], @selector(mdsSetType));
...
+ (void)exchangeWeexEditComponent
{
    ...
    Method exchangeM1 = class_getInstanceMethod([WXEditComponent class], @selector(mdsEdit_setAutofocus:));
    ...
    exchangeM1 = class_getInstanceMethod([WXEditComponent class], @selector(mdsEdit_initWithRef:type:styles:attributes:events:weexInstance:));
    method_exchangeImplementations(originalM1, exchangeM1);
    
    originalM1 = class_getInstanceMethod([WXEditComponent class], @selector(viewDidLoad));
    exchangeM1 = class_getInstanceMethod([WXEditComponent class], @selector(mdsEdit_viewDidLoad));
    method_exchangeImplementations(originalM1, exchangeM1);
    
    originalM1 = class_getInstanceMethod([WXEditComponent class], @selector(keyboardWasShown:));
    exchangeM1 = class_getInstanceMethod([WXEditComponent class], @selector(mdsEdit_keyboardWasShown:));
    method_exchangeImplementations(originalM1, exchangeM1);
...
//    Method exchangeM2 = class_getInstanceMethod([WXEditComponent class], @selector(mdsEdit_textView:shouldChangeTextInRange:replacementText:));
...
+ (void)exchangeWeexTextComponent
{
    ...
    SEL exchSEL = @selector(mdsText_initWithRef:type:styles:attributes:events:weexInstance:);
...
+ (void)exchangeWeexScrollerComponent
{
    ...
    Method exchangeM = class_getInstanceMethod([WXScrollerComponent class], @selector(mdsScroller_initWithRef:type:styles:attributes:events:weexInstance:));
    method_exchangeImplementations(originalM, exchangeM);
    ...
    Method exchangeM2 = class_getInstanceMethod([WXScrollerComponent class], @selector(mdsScroller_scrollViewDidScroll:));
    method_exchangeImplementations(originalM2, exchangeM2);
    ...
    Method exchangeM3 = class_getInstanceMethod([WXScrollerComponent class], @selector(mdsScroller_loadView));
    ...
    Method exchangeM4 = class_getInstanceMethod([WXScrollerComponent class], @selector(mdsList_loadView));
    ...
    Method exchangeM5 = class_getInstanceMethod([WXScrollerComponent class], @selector(mdsScroller_viewDidLoad));
...
+(void)exchangeWeexPlaceholderImageComponent
{
    ...
    SEL exchSEL = @selector(mds_updatePlaceHolderWithFailedBlock:);
...
+(void)exchangeWeexContentImageComponent
{
    ...
    Method originalM = class_getInstanceMethod([WXImageComponent class], oriSEL);
    SEL exchSEL = @selector(mds_updateContentImageWithFailedBlock:);
    Method exchangeM = class_getInstanceMethod([WXImageComponent class], exchSEL);
...
+(void)exchangeWeexGetEnvironment
{
    ...
    /** 获取自定义的mds_registerDefaultHandlers方法 */
    Method exchangeM = class_getClassMethod([MDSGetEnvironment class], @selector(mds_getEnvironment));
...
+(void)exchangeSDKInstance
{
    ...
    SEL exchSEL = @selector(mds_destroyInstance);
    ...
    exchSEL = @selector(mds__renderWithMainBundleString:);
...
+ (void)exchangeWXBridgeManager
{
    ...
    Method exchangeM = class_getInstanceMethod([WXBridgeManager class], @selector(mds_fireEvent:ref:type:params:domChanges:));
    method_exchangeImplementations(originalM, exchangeM);
}
...
+ (void)exchangeWXWebComponent
{
    ...
    Method exchangeM = class_getInstanceMethod([WXWebComponent class], @selector(mds_webViewDidFinishLoad:));
    method_exchangeImplementations(originalM, exchangeM);
    ...
    Method exchangeMViewDidLoad = class_getInstanceMethod([WXWebComponent class], @selector(mds_viewDidLoad));
    ...
    Method exchangeMSetUrl = class_getInstanceMethod([WXWebComponent class], @selector(mds_setUrl:));
    ...
    Method exchangeMLoadUrl = class_getInstanceMethod([WXWebComponent class], @selector(mds_loadURL:));
...
+ (void)exchangeRecyclerComponent
{
    ...
    Method exchangeM = class_getInstanceMethod([WXRecyclerComponent class], @selector(mdsRecycler_loadView));
    method_exchangeImplementations(originalM, exchangeM);
}
