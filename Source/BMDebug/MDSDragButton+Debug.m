...
@interface MDSDragButton()

@end


@implementation MDSDragButton(Debug)
...
+ (instancetype)debugButton
{
    ...
    MDSDragButton *btn = [[MDSDragButton alloc] initWithFrame:frame];
...
- (void)showDebug
{
    ...
    UIAlertAction *set = [UIAlertAction actionWithTitle:@"Setting" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        MDSNavigationController * nav = [[MDSNavigationController alloc] initWithRootViewController:[[DebugSettingVC alloc] init]];
    ...
    UIAlertAction *debug = [UIAlertAction actionWithTitle:@"Scan" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        [[MDSMediatorManager shareInstance].currentViewController.navigationController pushViewController:scanVc animated:YES];
    ...
    UIViewController* topVC =  [[MDSMediatorManager shareInstance] currentViewController];
