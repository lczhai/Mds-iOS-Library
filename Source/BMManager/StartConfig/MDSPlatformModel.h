...
//  Pods
//
//  Created by jony on 2018/8/15.
//
//

#import <Foundation/Foundation.h>

@interface MDSPlatformModelPage : NSObject
...
@interface MDSPlatformModelUrl : NSObject
...
@interface MDSPlatformModelGetui : NSObject
...
@interface MDSTabBarItem : NSObject
...
@interface MDSPlatformModelTabBar : NSObject
...
@interface MDSPlatformModel : NSObject
...
@property (nonatomic, strong) MDSPlatformModelPage *page;
@property (nonatomic, strong) MDSPlatformModelUrl *url;
@property (nonatomic, strong) MDSPlatformModelGetui *getui;
@property (nonatomic, strong) MDSPlatformModelTabBar *tabBar;
@end
