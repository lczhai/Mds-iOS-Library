...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(startApp) name:K_MDSAppReStartNotification object:nil];
...
- (BOOL)application:(UIApplication *)application openURL:(NSURL *)url sourceApplication:(NSString *)sourceApplication annotation:(id)annotation
{
    ...
    result = [MDSRouterManager application:application openURL:url sourceApplication:sourceApplication annotation:annotation];
    return result;
}
...
-(void)startApp
{
    ...
    /* 初始化数据 */
    [MDSConfigManager configDefaultData];
    
    /** 加载页面 */
    self.window.rootViewController = [[MDSMediatorManager shareInstance] loadHomeViewController];
