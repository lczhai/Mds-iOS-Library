...
const char * MDSResource_Check_Queue_1 = "MDSResource_Check_Queue_1";

const char * MDSResource_Check_Queue_2 = "MDSResource_Check_Queue_2";

const char * MDSResource_Check_Queue_3 = "MDSResource_Check_Queue_3";


@implementation MDSResourceCheck
...
+(void)checkResourceByMd5Dict:(NSDictionary*)md5Dict result:(mdsResourceCheckResult)result
{
    ...
    NSMutableArray * md5Array = [[NSMutableArray alloc] initWithCapacity:0];
     ...
     dispatch_queue_t queue1 = dispatch_queue_create(MDSResource_Check_Queue_1, DISPATCH_QUEUE_SERIAL);
     dispatch_queue_t queue2 = dispatch_queue_create(MDSResource_Check_Queue_1, DISPATCH_QUEUE_SERIAL);
     dispatch_queue_t queue3 = dispatch_queue_create(MDSResource_Check_Queue_1, DISPATCH_QUEUE_SERIAL);
