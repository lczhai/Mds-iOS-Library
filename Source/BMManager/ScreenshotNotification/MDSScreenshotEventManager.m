...
@interface MDSScreenshotEventManager ()
...
@implementation MDSScreenshotEventManager
...
- (void)toFeedBackVc
{
    ...
    // fire 截屏后的事件
    [MDSGlobalEventManager sendGlobalEvent:MDSScreenshotFeedbackEvent params:nil];
}

#pragma mark - Public Method
+ (instancetype)shareInstance
{
    static MDSScreenshotEventManager *_instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _instance = [[MDSScreenshotEventManager alloc] init];
    });
