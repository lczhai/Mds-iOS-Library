//
//  MDSPresentTranslationTransition.m
//  Pods
//
...
@implementation MDSPresentTranslationTransition
{
    MDSPresentTranslationTransitionType _transitionType;
}
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    switch (_transitionType) {
        case MDSPresentTranslationTransitionTypePresent:
            [self presentAnimation:transitionContext];
            break;
        case MDSPresentTranslationTransitionTypeDismiss:
