...
@implementation MDSPresentLikeQQTransition
{
    MDSPresentLikeQQTransitionType _transitionType;
}
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    switch (_transitionType) {
        case MDSPresentLikeQQTransitionTypePresent:
            [self presentAnimation:transitionContext];
            break;
        case MDSPresentLikeQQTransitionTypeDismiss:
...
- (void)presentAnimation:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    /** 初始化手势控制 */
    MDSInteractiveTransition *interactiveDismiss = [MDSInteractiveTransition interactiveTransitionWithTransitionType:MDSInteractiveTransitionTypeDismiss GestureDirection:MDSInteractiveTransitionGestureDirectionLeft];
    [interactiveDismiss addPanGestureForView:tempView handleViewController:toVc];
    /** 将手势控制添加到 将要出现的 Controller 上 */
    objc_setAssociatedObject(toVc, "mdsInteractive", interactiveDismiss, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
