...
@interface MDSTabBarController ()

@property (nonatomic, assign) BOOL isLoadImage;

@end

@implementation MDSTabBarController
...
- (void)viewDidLoad {
    ...
    [[MDSMediatorManager shareInstance] setBaseTabBarController:self];
}
...
//    self.tabBar.tintColor = UIColorFromValue(0x00b4cb);
    ...
    for (int i = 0; i < [items count]; i++) {
        ...
        MDSTabBarItem *itemInfo = self.tabBarInfo.list[i];
