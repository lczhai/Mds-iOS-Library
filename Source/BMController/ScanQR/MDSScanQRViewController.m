...
@interface MDSScanQRViewController ()<AVCaptureMetadataOutputObjectsDelegate>
...
@implementation MDSScanQRViewController
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection
{
    ...
    if (self.callback) {
        ...
        NSDictionary *resultData = [NSDictionary configCallbackDataWithResCode:MDSResCodeSuccess msg:nil data:_content4QRCode];
