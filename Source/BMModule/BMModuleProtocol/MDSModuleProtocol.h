...
@protocol MDSModuleProtocol <NSObject>

#pragma mark ----- MDSRouterModule 相关方法 -------------------------------------
@optional
/**
 js调用native 跳转页面方法
...
#pragma mark ----- MDSAxiosNetworkModule 相关方法 -------------------------------
/**
 js调用native 请求数据方法
...
#pragma mark ----- MDSHeaderModule 相关方法 -------------------------------
/**
 设置导航栏title
...
#pragma mark ----- MDSGeolocationModule 相关方法 ---------------------------
...
#pragma mark ----- MDSModalModule 相关方法 ---------------------------------
...
#pragma mark ----- MDSCameraModule 相关方法 ---------------------------------
...
#pragma mark ----- MDSStorageModule 相关方法 ---------------------------------
...
#pragma mark ----- MDSShareModule 相关方法 ---------------------------------
...
#pragma mark ----- MDSAppConfigModule 相关方法 ---------------------------------
...
#pragma mark ----- MDSToolsModule 相关方法 ---------------------------------
