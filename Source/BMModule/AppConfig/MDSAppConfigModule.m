//
//  MDSAppConfigModule.m
//  MDS-Chia
//
//  Created by jony on 2018/3/13.
//  Copyright © 2017年 XHY. All rights reserved.
//

#import "MDSAppConfigModule.h"

@implementation MDSAppConfigModule
...
- (void)changeFontSize:(NSDictionary *)info callback:(WXModuleCallback)callback
{
    ...
    if (callback) {
        ...
        NSDictionary *resultDic = [NSDictionary configCallbackDataWithResCode:MDSResCodeSuccess msg:nil data:data];
        callback(resultDic);
    }
