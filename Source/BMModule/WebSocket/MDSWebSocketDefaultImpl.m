...
@interface MDSWebSocketDefaultImpl() <SRWebSocketDelegate>

@property (nonatomic,strong) SRWebSocket *webSocket; /**< socket */
@property (nonatomic,weak) id<MDSWebSocketDelegate> delegate; /**< MDSWebSocketDelegate */
@property (nonatomic,assign) BOOL isConnect;

@end

@implementation MDSWebSocketDefaultImpl

#pragma mark - MDSWebSocketHandler
