...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/lczhai/Mds-iOS-Library"
  s.license      = "MIT"
  s.author       = { "chia" => "zhailuo@163.com" }

  s.platform     = :ios, "8.0"
  s.ios.deployment_target = "8.0"
  s.source       = { :git => "https://github.com/lczhai/Mds-iOS-Library", :tag => s.version.to_s }
  s.requires_arc = true
  ...
  s.dependency 'UMengUShare/Social/WeChat', '6.4.7'
